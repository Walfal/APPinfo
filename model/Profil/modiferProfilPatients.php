...
if(isset($_POST['matricule'])) {
    ...
    $statement -> execute(array($matricule2, $nom, $prenom, $sexe, $mail, $num_ss, $adresseRue, $adresseVille, $codePostal, $telephone, $poids, $taille, $dateDeNaissance, $password, $role, $photo, $medecin, $matricule));
