	...
	<form>
		<div class="gauche">
			<div class="contenu">	
				...
				<div class="form-group">
					<li><label for="dateDeNaissance"><?= $datenaissance ?></label><br>
				...
				<div class="form-group">
					<li><label for="Numss"><?= $NSS ?></label> <br>
				...
				<div class="form-group">
					<li><label for="Taille"><?= $taille ?></label><br>
				...
				<div class="form-group">
					<li><label for="Medecin"><?= $medecin ?> </label><br>
