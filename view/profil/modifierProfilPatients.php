...
<div class="banniere">
    <div class="content">
        <h2>Modifier profil de <?='' . $prenom .' ' .$nom; ?></h2> 
    </div>
    <div class="image">
...
<form class="formulaire" action="<?= '../../view/profil/modifierProfilPatients.php?id=' ?>" role="form" method="post" enctype="multipart/form-data">
    <div class="contenu">   
        <input type="hidden"  id=Matricule name="matricule" value=" <?= $_GET['id']; ?>">
        <div class="form-group">
            <li><label for="Matricule2"> Matricule : </label> <br>
            <input class="champ" type="text"  id=Matricule2 name="matricule2" value=" <?= $_GET['id']; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="Nom">Nom :</label><br>
            <input type="text" class="champ" id=Nom name="nom" value=" <?= $nom; ?>"></li>    
            <li class="espacement"><label for="Prenom">Prénom :</label><br>
            <input type="text" class="champ" id=Prenom name="prenom" value=" <?= $prenom; ?>" ></li>    
        </div>		
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text"  class="champ" id=Numss name="num_ss" value="<?= $num_ss; ?>"></li>
        </div>	 		
        <div class="form-group">
            <li><label for="AdresseRue">Adresse (numéro et voie) :</label><br>
            <input type="text" class="champ" id=AdresseRue name="adresseRue" value=" <?= $adresseRue; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="AdresseVille">Adresse (ville) :</label><br>
            <input type="text" class="champ" id=AdresseVille name="adresseVille" value=" <?= $adresseVille; ?>"></li>
            <li class="espacement"><label for="CodePostale">Code postal :</label><br>
            <input type="text" class="champ" id=CodePostal name="codePostal" value=" <?= $codePostal; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="Telephone">Téléphone :</label><br>
            <input type="tel" class="champ" id=Telephone name="telephone" value=" <?= $telephone; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="Mail">Mail :</label><br>
            <input type="email" class="champ" id=Mail name="mail" value=" <?= $mail; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="Motdepasse">Mot de passe :</label><br>
            <input type="password"class="champ" id=Motdepasse name="motDePasse" value="<?= $motDePasse; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="Poids">Poids :</label><br>
            <input type="text"  class="champ" id=Poids name="poids" value=" <?= $poids; ?>"></li>
            <li class="espacement"><label for="Taille">Taille :</label><br>
            <input type="text" class="champ" id=Taille name="taille" value=" <?= $taille; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="dateDeNaissance">Date de naissance :</label><br>
            <input type="text" class="champ" id=DateDeNaissance name="dateDeNaissance" value=" <?= $dateDeNaissance; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="Role">Rôle :</label><br>
            <input type="text" class="champ" id=Role name="role" value=" <?= $role; ?>"></li>
        </div>
        <div class="form-group">
            <li><label for="Medecin">Médecin :</label><br>
            <input type="text" class="champ" id=Medecin name="medecin" value=" <?= $medecin; ?>"></li>
        </div>
        <div class="actions">
            <div class="modify">
