...
<html lang="fr">
    ...
    <form>
       	<div class="principal">
    		...
    		<div class="linedisplay">
    			<li>
    				<label for ="adMail*"> Adresse Email* : </label><br>
	    			<input class="champ" type="email" name ="Adresse Email" id="Adresse Email" required></input>
	    		</li>
	    	</div>		    	 		
    		<div class="linedisplay">
    			<li><label for ="password*"> Mot de passe* : </label><br>
	    		<input class="champ" type="password" name ="Adresse Email" id="Adresse Email" required></input></li>
	    		<li class="espacement"><label for ="adMail*"> Confirmation du mot de passe* : </label><br>
	    		<input class="champ" type="password" name ="Adresse Email" id="Adresse Email" required></input></li>
	    	</div>		    	 		
    		<div class="linedisplay">
			...
			<div class="linedisplay">
    			<li>
    				<label for ="adMail*"> Numero de téléphone* : </label><br>
	    			<input type="tel"class="champ"></input>
	    		</li>	
	    	</div>	    	 			
		</div>
		<div class="validate">
